...
describe Chatcraft::Messages::Message, '#parts' do

  it "converts an empty message into an empty message" do
    message = Chatcraft::Messages::Message.new('')
  ...
  it "converts a one word message into a one element message" do
    message = Chatcraft::Messages::Message.new('test')
  ...
  it "converts a two word message into a two element message" do
    message = Chatcraft::Messages::Message.new('test this')
...
describe Chatcraft::Messages::Message, '#[]' do
  it "returns the respective element of the message" do
    message = Chatcraft::Messages::Message.new("give \"John Smith\" a bacon roll")
    message[1].should == 'John Smith'
  end
end

describe Chatcraft::Messages::Message, '#rest' do
...
describe Chatcraft::Messages::Message, '#match' do
  ...
  it "matches a pattern which matches the whole message" do
    message = Chatcraft::Messages::Message.new('hi there')
